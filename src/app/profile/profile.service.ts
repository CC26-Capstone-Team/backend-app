...
export async function addUserProfile(userId: string, major: string, gpa: number) {
...
export async function editUserProfile(user_id: string, major?: string, gpa?: number) {
